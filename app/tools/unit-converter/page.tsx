...
export const metadata: Metadata = { title: meta["unit-converter"].t, description: meta["unit-converter"].d, alternates: { canonical: `https://pdf24x.com/tools/unit-converter` } };
export default function Page() {
  return (
    <>
      <ToolJsonLd name="Unit Converter" description="Convert length, weight, temperature, speed and area units instantly." url="https://pdf24x.com/tools/unit-converter" category="Utility" />
      <Client />
    </>
  );
}
