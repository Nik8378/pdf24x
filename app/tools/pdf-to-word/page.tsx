...
export const metadata: Metadata = {
  ...
  description: "Convert PDF files to editable Word documents. This tool is coming soon to PDF24x.",
  robots: { index: false },
};
      ...
      <main className="flex-1 min-w-0 px-4 sm:px-6 lg:px-8 py-5 flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-sm">
          ...
          <p className="text-[13.5px] text-[#7a7875] mb-6 leading-relaxed">
            PDF to Word conversion is under development. Try our other free tools in the meantime.
          </p>
