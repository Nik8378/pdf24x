...
export const metadata: Metadata = { title: meta["word-counter"].t, description: meta["word-counter"].d, alternates: { canonical: `https://pdf24x.com/tools/word-counter` } };
export default function Page() {
  return (
    <>
      <ToolJsonLd name="Word Counter" description="Count words, characters, sentences, paragraphs and read time instantly." url="https://pdf24x.com/tools/word-counter" category="Utility" />
      <Client />
    </>
  );
}
